      ...
      class E extends r.default.Component {
        ...
        render() {
          ...
          I &&
            ...
            (I = T.concat(P)));
          let v = r.default.Children.toArray(this.props.children).filter(
            Boolean,
          );
          _ && !i && (v = this.makeStylesheetInert(v));
          let O = !1,
            b = !1;
          ...
          try {
            ...
            return (
              r &&
                o > r &&
                (c.add(t.page),
                console.warn(`Warning: data for page "${t.page}"${t.page === e.dangerousAsPath ? "" : ` (path "${e.dangerousAsPath}")`} is ${a(o)} which exceeds the threshold of ${a(r)}, this amount of data can reduce performance.
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
      ...
      I[i.NEXT_BUILTIN_DOCUMENT] = function () {
        return r.default.createElement(
          y,
          null,
          r.default.createElement(E, null),
    ...
    267: (e, t, n) => {
      e.exports = n(9847).vendored.contexts.HtmlContext;
    },
    9678: (e, t, n) => {
      Object.defineProperty(t, "__esModule", { value: !0 }),

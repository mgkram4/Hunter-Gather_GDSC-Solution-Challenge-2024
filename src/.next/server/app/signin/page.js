    ...
    (e.modules = {
      ...
      6461: (e, n, t) => {
        ...
        let d = [
              ...
              children: [
                "signin",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(t.bind(t, 3063)),
                        "/home/bryan/Documents/github/gdsc/gdsc/src/app/signin/page.tsx",
                      ],
                    },
                  ],
                },
            ...
            {
              layout: [
                () => Promise.resolve().then(t.bind(t, 9224)),
                "/home/bryan/Documents/github/gdsc/gdsc/src/app/layout.tsx",
              ],
              "not-found": [
                () => Promise.resolve().then(t.t.bind(t, 3472, 23)),
      ...
      4100: (e, n, t) => {
        Promise.resolve().then(t.t.bind(t, 5483, 23)),
          Promise.resolve().then(t.t.bind(t, 6544, 23)),
          Promise.resolve().then(t.t.bind(t, 7680, 23)),
          Promise.resolve().then(t.t.bind(t, 4138, 23)),
          Promise.resolve().then(t.t.bind(t, 8705, 23)),
          Promise.resolve().then(t.t.bind(t, 7974, 23));
      },
      570: () => {},
      4868: () => {},
      9224: (e, n, t) => {
        "use strict";
        t.r(n), t.d(n, { default: () => a, metadata: () => i });
        var r = t(657),
          o = t(7337),
          s = t.n(o);
        t(642),
